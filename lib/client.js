          ...
          () =>
            locale.register(NS, {
              en: {
                ...
                setModelLabel: "Worker model override",
                setModelHint: "Empty means use the global default model. Format: provider/model-id (e.g. anthropic/claude-3.5-sonnet).",
        ...
        !ready ? el("p", { className: "_tskMeta" }, t("loading")) : el(
          ...
          el(
            ...
            el(
              "div",
              { className: "_tskSetLabelWrap" },
              el("span", { className: "_tskSetLabel" }, t("setModelLabel")),
              el("span", { className: "_tskMeta" }, t("setModelHint")),
              modelOverridden ? el("span", { className: "_tskBadge" }, t("overridden")) : null
            ),
            el("input", {
              className: "_tskInput",
              value: modelText,
              ...
              onBlur: commitModel,
              onKeyDown: (e) => { if (e.key === "Enter") commitModel(); if (e.key === "Escape") setModelDraft(null); },
            })
          ),
          modelOverridden
            ? el("button", { type: "button", className: "_tskExpand", onClick: resetModel, disabled: !writable }, t("reset"))
            : null,
          el(
            "div",
            { className: "_tskSetRow" },
