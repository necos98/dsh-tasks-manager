...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // direct writes (no staging): a switch for workerCanFinish + a text
    // field for baseBranch. Switch OFF unsets (re-inherits the default
    // false); an empty branch unsets (re-inherits ""). Overridden badges
    // read the user layer, exactly like the built-in cards.
