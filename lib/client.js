...
// promotes exactly that task.
// approve/close/start/setQueueEnabled stay USER-ONLY: they travel the plugin
// RPC channel (/tasks-queue via ctx.connection.rpc.call), never model tools.
//
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function TaskCard({ task, busy, spawn, onApprove, onDiscard, onClose, onStart, queueEnabled, t }) {
